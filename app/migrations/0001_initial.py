    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(max_length=164, unique=True)),
                ('group', models.CharField(default='padrao', max_length=15)),
                ('session', models.CharField(default='', max_length=100)),
                ('permission', models.ForeignKey(default=60, on_delete=django.db.models.deletion.CASCADE, to='app.classificacao')),
            ],
        ),
    ]
